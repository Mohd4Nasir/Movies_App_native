...
import { fetchTVSeries, Image185 } from '../Api/moivesdb';
...
const Web_series = () => {
    ...
    const getTvSeries = async () => {
        try {
            setLoading(true);
            const response = await fetchTVSeries(); // Assuming this function makes an API call and returns a promise
    ...
    return (
        ...
        <View className="absolute z-20 w-full flex-row justify-between items-center px-4 mt-10">
            ...
            <View className="pt-12 mt-10">
                <Text className="text-white text-4xl pl-2">Web Series</Text>
                {loading ? (
